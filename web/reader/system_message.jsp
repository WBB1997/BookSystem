...
<script type="text/html" id="statusTpl">
    ...
    {{#  }else if (d.Status === '未查看'){ }}
    <div align="center">
        <lable style="color: green">未查看</lable>
    </div>
    {{#  }}}
</script>
...
<script>
    layui.use(['form', 'laypage', 'layer', 'table', 'upload', 'element'], function () {
        ...
        table.render({
            ...
            , id: 'bookTable'
            , height: 'full-100'
            , url: '<%=request.getContextPath()%>/ReaderServlet?action=getReaderMessage' //数据接口
            ...
            , cols: [[ //表头
                ...
                {field: 'Title', align: 'center', title: '标题' , width: '10%'}
                , {field: 'Message', title: '内容'}
                , {field: 'Time', align: 'center', title: '时间', width: '10%'}
                , {field: 'Status', align: 'center', title: '状态', templet: '#statusTpl', width: '10%'}
        ...
        function flushTab() {
            ...
            table.reload('bookTable', {
                url: '<%=request.getContextPath()%>/ReaderServlet?action=getReaderMessage'
            });
        }
    });
</script>
