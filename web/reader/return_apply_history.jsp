...
<script>
    layui.use(['form', 'laypage', 'layer', 'table', 'upload', 'element'], function () {
        ...
        table.render({
            ...
            , id: 'bookTable'
            , height: 'full-100'
            , url: '<%=request.getContextPath()%>/ReaderServlet?action=getReaderReturnApplyHistory' //数据接口
        ...
        $("#searchId").click(function () {
            ...
            table.reload('bookTable', {
                url: '<%=request.getContextPath()%>/ReaderServlet?action=getReaderReturnApplyHistory&keyword=' + searchWord
            });
        });
        ...
        function flushTab() {
            ...
            table.reload('bookTable', {
                url: '<%=request.getContextPath()%>/ReaderServlet?action=getReaderReturnApplyHistory'
            });
        }
