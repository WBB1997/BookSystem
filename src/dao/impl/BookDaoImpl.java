...
public class BookDaoImpl implements IBookDao {
    ...
    @Override
    public List<Book> queryAllBook(String word, int pageNow, int pageSize) throws Exception {
        Connection connection = DatabaseBean.getConnection();
    ...
    @Override
    public List<Book> queryBookOfKeyword(String parameter, String word, int pageNow, int pageSize) throws Exception {
        Connection connection = DatabaseBean.getConnection();
